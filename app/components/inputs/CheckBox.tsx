...
const CheckBox: React.FC<CheckBoxProps> = ({ label, checked, onChange, alternateColor, id }) => {
  return (
    <label className="flex items-center space-x-2 cursor-pointer text-sm flex-grow whitespace-wrap" id={id}>
